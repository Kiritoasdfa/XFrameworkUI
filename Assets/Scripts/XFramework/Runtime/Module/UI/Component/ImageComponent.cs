...
{
    public class ImageComponent : GraphicComponent<Image>
    {
        ...
        public async Task SetSpriteAsync(string key, bool setNativeSize)
        {
    ...
    public static class UIImageExtensions
    {
        ...
        {
            return self.TakeComponent<ImageComponent>(true);
        }
        ...
        public async static Task SetSpriteAsync(this Image self, XObject parent, string key, bool setNativeSize)
        {
