...
namespace XFramework
{
    ...
    {
        public abstract class Component : XObject
        {
            protected UI parent;

            public UI Parent => parent;

            protected sealed override void OnStart() { base.OnStart(); }
        ...
        /// 此UI身上挂的UI组件
        /// </summary>
        protected Dictionary<Type, Component> uiComponents;
        ...
        protected sealed override void OnStart() 
        {
            ...
            uiComponents = ObjectPool.Instance.Fetch<Dictionary<Type, Component>>();
        }
        ...
        private void RemoveUIComponent(Component component)
        {
            if (component == null)
                return;
        ...
        public void AddUIComponent(Component component)
        {
            ...
            if (!TypesManager.Instance.TryGetUCompType(type, out var baseType))
                baseType = type;

            this.AddUIComponent(baseType, component);
        }
        ...
        /// <param name="component"></param>
        private void AddUIComponent(Type fixedType, Component component)
        {
            Type type = fixedType;
        ...
        /// <returns></returns>
        public T GetUIComponent<T>(bool inherit = true) where T : Component
        {
            Type type = typeof(T);
            if (!TypesManager.Instance.TryGetUCompType(type, out var baseType))
                baseType = type;

            if (!uiComponents.TryGetValue(baseType, out var comp))
            {
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public Component GetUIComponent(Type type)
        {
            if (!TypesManager.Instance.TryGetUCompType(type, out var baseType))
                baseType = type;
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="inherit">继承</param>
        public void RemoveUIComponent<T>(bool inherit = false) where T : Component
        {
        ...
        public UI AddChild(Type type, string keyOrPath, bool isFromPool = false)
        {
            ...
            UI child = this.AddChildFromReference(type, keyOrPath, isFromPool, false) ?? this.AddChildFromPath(type, keyOrPath, isFromPool, true);
        ...
        protected sealed override void OnDestroy()
        {
            ...
            foreach (Component comp in uiComponents.Values)
            {
                comp.Dispose();
            }
            uiComponents.Clear();
