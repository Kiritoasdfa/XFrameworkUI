...
namespace XFramework
{
    public class AAResourcesLoader : ResourcesLoader
    {
        ...
        public override async Task<GameObject> InstantiateAsync(string path, Transform parent)
        {
            var op = Addressables.InstantiateAsync(path, parent);
        ...
        public async override Task<UnityEngine.Object> LoadAssetAsync(string key, Type type)
        {
            var op = Addressables.LoadAssetAsync<UnityEngine.Object>(key);
            await op.Task;
