...
namespace XFramework
{
    public sealed class SceneResManager : Singleton<SceneResManager>, IDisposable
    {
        ...
        /// <param name="loadSceneMode"></param>
        /// <returns></returns>
        public static SceneObject LoadSceneAsync(string key, LoadSceneMode loadSceneMode = LoadSceneMode.Single)
        {
            if (!Check())
                return null;
        ...
        /// <returns></returns>
        public static async Task UnloadSceneAsync(object handle)
        {
            if (!Check())
                return;
        ...
        /// <returns></returns>
        public static async Task WaitForCompleted(SceneObject sceneObject)
        {
            if (!Check())
                return;
