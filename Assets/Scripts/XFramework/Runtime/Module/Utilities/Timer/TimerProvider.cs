...
namespace XFramework
{
    ...
    public sealed class TimerProvider: XObject, IAwake<ITimer>, IUpdate
    {
        private ITimer timerGetter;
        ...
        public void Initialize(ITimer args)
        {
            this.timerGetter = args;
        }
        ...
        {
            return this.timerGetter.GetTime();
        }
