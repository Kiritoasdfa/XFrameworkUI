...
namespace XFramework
{
    ...
    public sealed class AudioManager : CommonObject
    {
        ...
        /// <param name="igoneIfPlaying">如果正在播放音频，则忽略这一次播放</param>
        public void PlayAudio(AudioType audioType, string audioKey, bool igoneIfPlaying)
        {
            if (TryGetAudioSource(audioType, out var source))
            {
                if (source.isPlaying && igoneIfPlaying)
                    return;
        ...
        /// <param name="audioKey"></param>
        /// <param name="igoneIfPlaying">如果正在播放音频，则忽略这一次播放</param>
        public void PlayBgmAudio(string audioKey, bool igoneIfPlaying)
        {
            PlayAudio(AudioType.BGM, audioKey, igoneIfPlaying);
        }
        ...
        /// <param name="audioKey"></param>
        /// <param name="igoneIfPlaying">如果正在播放音频，则忽略这一次播放</param>
        public void PlaySFXAudio(string audioKey, bool igoneIfPlaying)
        {
            PlayAudio(AudioType.SFX, audioKey, igoneIfPlaying);
        }
